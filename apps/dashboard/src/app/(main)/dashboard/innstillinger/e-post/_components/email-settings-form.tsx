    ...
    <form ref={formRef} onSubmit={onSubmit} className="flex flex-col gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Bekreftelser på befaringer og varsel om nye henvendelser sendes via{" "}
            <a
          ...
          <FieldGroup className="gap-5">
            ...
            <Field className="gap-1.5">
              ...
              <Input
                ...
                placeholder="Hagehjelpen <post@hagehjelpen.no>"
              />
              <FieldDescription>Format: Navn &lt;epost@domene.no&gt;</FieldDescription>
            </Field>

            <Field className="gap-1.5">
              <FieldLabel htmlFor="lead_admin_email">Varsel om nye henvendelser</FieldLabel>
              <Input
                id="lead_admin_email"
                name="lead_admin_email"
                type="email"
                defaultValue={settings.lead_admin_email ?? ""}
                placeholder="post@hagehjelpen.no"
              />
              <FieldDescription>
                Valgfritt. Mottar kopi av nye henvendelser og befaringsbestillinger.
              </FieldDescription>
            </Field>
          </FieldGroup>
        </CardContent>
