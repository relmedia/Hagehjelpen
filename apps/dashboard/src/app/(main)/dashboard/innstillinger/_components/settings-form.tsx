    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <FieldGroup className="gap-5">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <Field className="gap-1.5">
                <FieldLabel htmlFor="org_number">Organisasjonsnummer</FieldLabel>
                <Input id="org_number" name="org_number" defaultValue={settings.org_number ?? ""} />
              </Field>
              <Field className="gap-1.5">
                <FieldLabel htmlFor="service_area">Dekningsområde</FieldLabel>
                <Input
                  id="service_area"
                  name="service_area"
                  defaultValue={settings.service_area ?? ""}
                  placeholder="Nord-Jæren og omegn"
                />
                <FieldDescription>Kort tekst som vises i bunnteksten og i kontaktseksjonen.</FieldDescription>
              </Field>
            </div>
            <div className="grid gap-5 sm:grid-cols-2">
              <Field className="gap-1.5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Brukes som utgangspunkt i plenkalkulatoren når arealet er ukjent.</CardDescription>
        </CardHeader>
        <CardContent>
          <FieldGroup className="gap-5">
            <Field className="gap-1.5">
              <FieldLabel htmlFor="hourly_rate">Timepris (kr)</FieldLabel>
              <Input
                id="hourly_rate"
                name="hourly_rate"
                type="number"
              ...
              />
              <FieldDescription>Vises ved arbeid som faktureres etter medgått tid.</FieldDescription>
            </Field>
          </FieldGroup>
        </CardContent>
      </Card>
