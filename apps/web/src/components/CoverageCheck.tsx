...
export function CoverageCheck() {
  ...
  return (
    <div className="flex h-full flex-col rounded-3xl border border-leaf-100 bg-white p-8 shadow-xl shadow-leaf-900/5">
      ...
      <form onSubmit={handleSubmit} className="mt-6 flex gap-2">
        ...
        <input
          ...
          placeholder="4053"
          className="w-32 rounded-xl border border-leaf-100 bg-white px-4 py-3 text-sm tracking-[0.2em] text-ink outline-none transition-shadow placeholder:tracking-[0.2em] placeholder:text-ink-soft/40 focus:border-leaf-400 focus:ring-2 focus:ring-leaf-400/20"
        />
        <button
          type="submit"
      ...
      <p className="mt-auto pt-6 text-xs leading-relaxed text-ink-soft/70">
